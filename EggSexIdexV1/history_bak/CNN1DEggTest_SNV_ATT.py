...
from train.module_dataset.CNN1DModule_SNV_CBAM import HyperspectralCNN, CustomDataset_Meng
from tabulate import tabulate


# 测试函数
def test_unseen_data(model_path, test_data_dir, thresholds=[0.5], device='cuda' if torch.cuda.is_available() else 'cpu',
...
if __name__ == "__main__":
    # 测试数据目录
    test_data_dir = r"D:\workspace\gdv-egg-model\Code_EggGenderDet\data_hlh_train\Dataset\huayu_fortest"
    model_path = r"D:\workspace\gdv-egg-model\Code_EggGenderDet\1DCNN_200epoch_SNV\huayu_hlh_delete_gt_4080_80_10_10_ATT\0\1DCNN_acc_0.937768_vloss_0.309450.pth"
