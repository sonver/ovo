...
def plot_all_spectral_curves(data_dir, wavelengths=WAVELENGTH_INFO[100:250], max_files=None):
    """绘制平均光谱曲线、按标准差排序的曲线和独立按均值排序的均值曲线"""
...
if __name__ == "__main__":
    data_dir = r"D:\workspace\gdv-egg-model\Code_EggGenderDet\data_hlh_train_20250907_hy\seg_all_0908_13d0h_8000"
    plot_all_spectral_curves(data_dir, max_files=300)