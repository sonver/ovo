...
from train.module_dataset.CNN1DModule_SNV_CBAM_SG_NOTEMP import *
        ...
        for model_type, file_name in [('val_acc', 'test_acc.txt'), ('f1_score', 'test_recall_f1.txt')]:
            ...
            if model_path and os.path.exists(model_path):
                try:
                    ...
                    test(model, test_loader, criterion, device, thresholds=[0.15, 0.25,0.3, 0.35, 0.4,0.45, 0.5, 0.6, 0.7],
...
if __name__ == '__main__':
    ...
    fold = r'D:\workspace\gdv-egg-model\Code_EggGenderDet\1DCNN_200epoch_SNV\mixed_715_notemp_floss'  # 母多公少，half，16*16
    EggNetMain()
