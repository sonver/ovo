...
if __name__ == '__main__':
    # Excel 表路径
    root_path = r'D:\workspace\gdv-egg-model\Code_EggGenderDet\data\2525年4月7日-褐蛋\3月预测结果增加34但设置34为0排除187之后.xlsx'
    # 源文件夹和目标文件夹
    source_folder = './data/egg_seg_data_half'
    destination_folder1 = './data/Dataset/drophalf/male'  # 公蛋存放目录
    destination_folder2 = './data/Dataset/drophalf/female'  # 母蛋存放目录
