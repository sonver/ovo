...
def getsex202412156(root_path, source_folder, destination_folder1, destination_folder2):
    ...
    for txt_file in txt_files:
        ...
        match = re.match(r'([0-9A-Za-z]+)-(\d+)\.txt', txt_file)
        if not match:
...
if __name__ == '__main__':
    # Excel 表路径
    root_path = r'D:\workspace\gdv-egg-model\Code_EggGenderDet\data_hlh_train\6month_xiaoming_hll.xlsx'
    # 源文件夹和目标文件夹
    source_folder = r"D:\workspace\gdv-egg-model\Code_EggGenderDet\data_hlh_train\seg_data_6month_xiaoming"
    destination_folder1 = r'D:\workspace\gdv-egg-model\Code_EggGenderDet\data_hlh_train\Dataset\xiaoming\male'  # 公蛋存放目录
    destination_folder2 = r'D:\workspace\gdv-egg-model\Code_EggGenderDet\data_hlh_train\Dataset\xiaoming\female'  # 母蛋存放目录
