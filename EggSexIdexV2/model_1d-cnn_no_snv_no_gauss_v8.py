...
ROOT_DIR         = r"hy_model/hy_model_1dcnn_v8_f1.0_m1.0-1224_no_clear_suspect_patchs"
...
class HyperspectralCNN(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        # x: [B, H, W, 150]
        if x.dim() != 4 or x.size(-1) != 150:
            raise RuntimeError("Expected input shape [B,H,W,150].")
        ...
        # ========== 像素展开 ==========
        x = x.view(B * H * W, 1, C)  # [B*H*W, 1, 150]
